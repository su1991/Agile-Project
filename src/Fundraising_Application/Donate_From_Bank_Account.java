 ...
 * @author floss
 */
public class Donate_From_Bank_Account extends javax.swing.JFrame {
     ...
     */
    public Donate_From_Bank_Account() {
        initComponents();
   ...
   for (int i=0;i<Customers.size() && !abort ;i++) {
      ...
      if (y[0].equals(Customers.get(i).getName().trim())  && y[1].equals(Customers.get(i).getPassword()) ){
                    ...
                    System.out.print(Customers.get(i).Username);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Donate_From_Bank_Account.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Donate_From_Bank_Account().setVisible(true);
            }
        });
    }
